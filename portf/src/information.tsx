...
function Detail({ children }: ParagraphProps) {
  return (
...
export const education = [
  ...
  { period: "2025.01 ~ 2025.04", school: "솔데스크 SAP ABAP" },
];
...
export const projectData = [
  ...
  },
  {
    ...
    discription2: [
      ...
      <Detail>1. 사용자 자신을 표현할 수 있는 요소 제공</Detail>,
      <Detail><span>&nbsp;&nbsp;</span>• 닉네임, 프로필 사진, 한 줄 소개, 프로필 <span className="inline md:hidden"><br />&nbsp;&nbsp;&nbsp;&nbsp;</span> 뮤직</Detail>,
      <Detail><span>&nbsp;&nbsp;</span>• Q&A 답변</Detail>,
      <Detail>2. 방문한 이웃이 남길 수 있는 방명록</Detail>,
      <Detail>3. 추가한 이웃 목록<br />
        <span>&nbsp;&nbsp;</span>• 이웃 목록 클릭 시 이웃의 페이지로 이동</Detail>,
      <Detail>4. 타자 게임 랭킹</Detail>,
      ...
      <Detail>• 로그인 시 사용한 아이디로 개인 페이지 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>링크 생성</Detail>,
      <Detail>• 페이지 이동 시 로그인 유지되도록 토큰 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>처리</Detail>,
      <Title text="메인 페이지" />,
      <Detail>• 개인별 페이지에 맞게 데이터 렌더링</Detail>,
      <Detail>• 사용자가 Q&A 답변 작성 시 데이터 전송 및 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>자동 새로고침</Detail>,
      <Detail>• 방명록 작성 시 데이터 전송 및 자동 새로<span className="inline md:hidden"><br />&nbsp;&nbsp;</span>고침</Detail>,
      <Detail>• 본인이 보는 메인페이지와 타인이 보는 메인 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>페이지 구별</Detail>,
      <Detail>• 아이디로 이웃 검색 및 추가 기능</Detail>,
      <Detail>• 이웃 아이디 클릭 시 해당 이웃 페이지로 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>이동</Detail>,
      <Title text="게시판" />,
      <Detail>• 카테고리에 맞는 게시물 데이터 렌더링</Detail>,
      <Detail>• 게시물 작성 시 사진 업로드 기능</Detail>,
      <Detail>• 게시물 클릭 시 해당 게시물 팝업 띄우기</Detail>,
      <Title text="마이페이지" />,
      <Detail>• 미니홈피 URL에 복사 클릭 시 개인별 링크 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>복사</Detail>,
  ...
  },
  {
    ...
    overview: ['• 웹캠을 통해 자신이 공부하는 모습을 전시',
      <div className="leading-5 md:leading-7">• 어플 내에서 친구들과 함께 공부할 수 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>있으면 좋겠다는 아이디어<span className="hidden md:inline"><br />&nbsp;&nbsp;</span>에서 착안</div>,
      <div className="leading-5 md:leading-7">• 사측의 요구사항: web과 app에서 처리 할 수 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>있는 기능을 구분<span className="hidden md:inline"><br />&nbsp;&nbsp;</span>하고 이를 모듈화된 API로 <span className="inline md:hidden"><br />&nbsp;&nbsp;</span>정립 감정과 상황을 공감하고 이해</div>,
